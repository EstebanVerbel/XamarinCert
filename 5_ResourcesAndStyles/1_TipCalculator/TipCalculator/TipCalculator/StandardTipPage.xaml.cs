...
namespace TipCalculator
{
	public partial class StandardTipPage : ContentPage
	{
		...
		{
            Resources["backgroudColor"] = Color.FromHex("#606060");
            Resources["foregroudColor"] = Color.FromHex("#C0C0C0");
		}

		void OnDark(object sender, EventArgs e)
		{
            Resources["backgroudColor"] = Color.FromHex("#C0C0C0");
            Resources["foregroudColor"] = Color.FromHex("#606060");
        }
